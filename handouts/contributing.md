...
* How to set up your development environment - this might exist in the README.md depending on the project. If so, then include a link
 ...
 * (optional) Include a [humans.txt](http://humanstxt.org/) file - to give accolades to contributors (store in your root directory just like your CONTRIBUTOR.md, on deployment, it will be available via your website www.yourwebsite.com/humans.txt) 
